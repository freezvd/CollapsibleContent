<dl class="qa--container">
    <dt class="qa--question" itemscope itemtype="http://schema.org/Question" data-show-icon="<?php $attributes['show_icon'];?>" data-hide-icon="<?php esc_attr_e( $attributes['hide_icon'] );?>">
