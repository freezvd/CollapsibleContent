 ...
 * Shortcode Procesors
 *
 * @package         MakeCreative\CollapsibleContent\Shortcode
 * @since           1.0.0
 * @author          makecreative
 * @license         GPL-2.0+
...
namespace MakeCreative\CollapsibleContent\Shortcode;
...
/**
* GEt the runtime configuration parameters for the shortcode
*
* @since 1.0.l
*
* @param string $shortcode_name Name of the shortcode
...
function get_shortcode_configuration( $shortcode_name ){
    ...
    $config = array(
        ...
        'defaults' => array(
            'show_icon' => 'dashicons-arrow-down-alt2',
...
//[teaser hidden_message="what question would you like to ask me?" show_icon="" hide_icon="]This is the answer[/teaser]
